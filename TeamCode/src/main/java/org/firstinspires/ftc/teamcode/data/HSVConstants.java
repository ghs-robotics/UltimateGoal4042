...
public interface HSVConstants {
    ...
    // Tower goal HSV values
    MyScalar LOWER_BLUE_TOWER_HSV = new MyScalar(0, 135, 79); // S = 135
    ...
    MyScalar LOWER_WOBBLE_HSV = new MyScalar(0, 100, 50);
    MyScalar UPPER_WOBBLE_HSV = new MyScalar(80, 255, 255);
