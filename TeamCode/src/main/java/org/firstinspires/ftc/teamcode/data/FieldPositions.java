...
public interface FieldPositions {
    ...
    int[] PERFECT_LAUNCH_POS = new int[]{140 + xOffset, 58}; // Perfect launch position
    ...
    int[] PARK_0_POS = new int[]{132 + xOffset, 74};
    int[] PARK_1_POS = new int[]{150 + xOffset, 74};
    int[] PARK_4_POS = new int[]{132 + xOffset, 74};

    // Position pertaining to the wobble goals
    int[] CONFIG_0_POS_I = new int[]{188 + xOffset, 90}; // Where to drop first wobble goal
    int[] CONFIG_0_POS_II = new int[]{157 + xOffset, 90}; // Where to drop second wobble goal

    int[] PRE_CONFIG_1_POS_I = new int[]{93 + xOffset, 85};
    int[] PRE_CONFIG_1_POS_II = new int[]{66 + xOffset, 85};
    int CONFIG_1_WALL_HEIGHT = 24;

    int[] PRE_CONFIG_4_POS_I = new int[]{188 + xOffset, 90};
